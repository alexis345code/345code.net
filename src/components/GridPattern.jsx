...
function Block({ x, y, ...props }) {
  // Draw a right triangle with width 3, height 4, filled, using the same transform
  // Points: (0,0), (3,0), (0,4)
  return (
    <motion.path
      transform={`translate(${-32 * y + 96 * x} ${160 * y}) translate(40 8) skewX(-11.53)`}
      d="M0 0 L78 0 L0 104 Z"
      {...props}
    />
  )
}
