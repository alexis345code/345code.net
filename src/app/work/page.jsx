...
export const metadata = {
  title: 'Our Work',
  description:
    'platform agnostic - finding the best tool for the job, not the other way round.',
}
...
export default async function Work() {
  ...
  return (
    <RootLayout>
      ...
      >
        <p>
          We have our favourite tools, but we're not married to any of them.
          The mosgt important thing is readability and reuseablilty of code.
          We work with you to choose the best tools for your project.
        </p>
      </PageIntro>
      ...
      >
        We approached <em>345code.net Ltd</em>&nbsp; because we loved their past work. They
